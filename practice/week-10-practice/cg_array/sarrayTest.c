...
/* Input to the threads - holds a shared array and the number of values to insert */
...
int main(int argc, char* argv[]) {
	...
	status = pthread_create(&tid1, NULL, (void*(*)(void*))insert, (void*)&input);  //0-sz-1 
	status = pthread_create(&tid2, NULL, (void*(*)(void*))insert, (void*)&input);  //0-sz-1 
